...
# Fetch existing vnd data
existing_data = conn.read(worksheet="vnd", usecols=list(range(6)), ttl=5)
    ...
    with st.form(key="vendor_form"):
        ...
        if submit_button:
            if not company_name or not business_type:
                ...
                conn.update(worksheet="vnd", data=updated_df)
...
# Delete Vendor
    ...
    if st.button("Delete"):
        ...
        conn.update(worksheet="vnd", data=existing_data)
